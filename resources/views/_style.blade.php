...
<link rel="stylesheet" href="{{url('/')}}/assets/revolution/css/settings.css" />
<link rel="stylesheet" href="{{url('/')}}/assets/css/font-icons.css" />
<link rel="stylesheet" href="{{url('/')}}/assets/css/rev-slider.css" />
<link rel="stylesheet" href="{{url('/')}}/assets/css/sliders.css" />
<link rel="stylesheet" href="{{url('/')}}/assets/css/style.css" />
<link rel="stylesheet" href="{{url('/')}}/assets/css/ionicons.min.css" />
<link href="{{url('/')}}/assets/css/icofont.min.css" rel="stylesheet" />
